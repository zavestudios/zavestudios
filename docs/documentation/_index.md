...
- **[Contract Schema](https://github.com/zavestudios/platform-docs/blob/main/_platform/CONTRACT_SCHEMA.md)** - Tenant contract specification (zave.yaml)
- **[Contract Validation](https://github.com/zavestudios/platform-docs/blob/main/_platform/CONTRACT_VALIDATION.md)** - Contract validation rules and enforcement
- **[Lifecycle Model](https://github.com/zavestudios/platform-docs/blob/main/_platform/LIFECYCLE_MODEL.md)** - Tenant lifecycle states and transitions

**Development & Automation:**

- **[Generator Model](https://github.com/zavestudios/platform-docs/blob/main/_platform/GENERATOR_MODEL.md)** - Four-stage generator specification (Repository, Pipeline, GitOps, Capability)
- **[Developer Experience](https://github.com/zavestudios/platform-docs/blob/main/_platform/DEVELOPER_EXPERIENCE.md)** - Local development environment standards

## Repository Directory

Browse all platform repositories organized by taxonomy in the [Repository Directory](repositories/).
